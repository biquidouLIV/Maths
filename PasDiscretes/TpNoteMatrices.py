...
def Exo5():
    ...
    Mactu = [35,20,10,2]
    Poids = [0.1,0.2,0.3,1]
    Puissance = [10,8,20,17]

    PoidsMax = Mmax[0]*Poids[0]+Mmax[1]*Poids[1]+Mmax[2]*Poids[2]+Mmax[3]*Poids[3]
    PoidsActu = Mactu[0]*Poids[0]+Mactu[1]*Poids[1]+Mactu[2]*Poids[2]+Mactu[3]*Poids[3]
    PuissanceFeu = Mactu[0]*Puissance[0]+Mactu[1]*Puissance[1]+Mactu[2]*Puissance[2]+Mactu[3]*Puissance[3]
...
def Exo6():
    ...
    classe = np.array([
             [0.5, 0.1, 1.5, 0.1],  # PV
             [0.1, 0.5, 0.1, 0.5],  # PM
             [1.5, 0.1, 0.5, 0.1],  # Force
             [0.1, 1.5, 0.1, 0.1],  # Magie
             [1.0, 0.1, 1.5, 0.1],  # Constitution
             [0.1, 1.0, 0.5, 0.1],  # Esprit
             [0.1, 0.1, 0.1, 1.0],  # Chance
             [0.1, 0.1, 0.1, 1.5]   # Rapidité
    ])
